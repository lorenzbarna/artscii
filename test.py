...
artscii.convert(artscii.image_from_path("test1.png"), res_path="test1.txt")

# Use a palette by loading it from a json and reverse it incase you are in a darkmode editor
print("Darkmoded palette:")
artscii.print_to_console(artscii.convert(artscii.image_from_path("test1.png"), darkmode=True, palette=artscii.load_palette("palettes/big_palette.json")))

# Finally play around with scale and font_ratio
print("Bigger (and wider) is better:")
artscii.print_to_console(artscii.convert(artscii.image_from_path("test1.png"), scale=0.4, font_ratio=0.2))